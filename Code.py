...
def global_kmeans(l,k):
 ...
 cen1=[]
 cen2=[]
 init_error=9999999999999999999999
     ...
     if(i==1):
      ...
      #I=i+1
       ...
       for j in range(0,len(l)):
          ...
          del(cen[len(cen)-1])
       #print(init_error)
       init_error=999999999999999999999
       #print(init_error)
...
y_val1=[]
#print(clusters)
colours=['bo','go','ro','co','mo','yo','ko','bx','gx','rx','cx','mx','yx','kx','b-','g-','r-']
"""for i in range(0,6):
    ...
    plt.plot(x_val1,y_val1,colours[i])
"""

no_of_clusters=[]
mean_squared_error=[]
for i in range(2,11):
    cen11=global_kmeans(nodes,i)
    mean_squared_error.append(float(dist(cen11,nodes)))
#print(error1)

for i in range(2,11):
    no_of_clusters.append(float(i))

plt.plot(no_of_clusters,mean_squared_error,'r')
plt.show()
